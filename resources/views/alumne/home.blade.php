                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                <b>Perfil completado</b> <a class="pull-right">80%</a>
                            </li>
                            <li class="list-group-item">
                            ...
                            <table id="example1" class="table table-bordered table-striped dataTable" role="grid"
                                ...
                                <tr role="row">
                                    <th class="sorting_asc" tabindex="0" aria-controls="example1" rowspan="1"
                                        ...
                                        style="width: 86px;" aria-sort="ascending">Empresa
                                    </th>
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                        ...
                                        style="width: 95px;">Puesto
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                        aria-label="Engine version: activate to sort column ascending"
                                        style="width: 71px;">Vacante
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                ...
                                <tr>
                                    ...
                                    <th rowspan="1" colspan="1">Puesto</th>
                                    <th rowspan="1" colspan="1">Vacantes</th>
                                    <th rowspan="1" colspan="1">Solicitudes</th>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
